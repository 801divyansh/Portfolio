    ...
    return (
        <section id="contact">
            <div className="mx-auto max-w-6xl">
                ...
                <p className="my-4 text-center text-2xl fornt-medium text-lime-300 lg:pt-6 lg:text-5xl">{CONTACT.email}</p>
                <p className="my-4 text-center text-2xl fornt-medium text-lime-300 lg:pt-6 lg:text-5xl">{CONTACT.phone}</p>
            </div>
